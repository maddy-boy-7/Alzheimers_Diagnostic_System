...
try:
    ...
    st.sidebar.markdown("<div style='text-align:center;font-size:3rem;'>Brain</div>", unsafe_allow_html=True)
...
# Contact
For inquiries, you can mail us [here](mailto:vtu22276@veltech.edu.in).
""")
