...
RSS_FEEDS = [
      {"url": "https://www.nia.nih.gov/news/rss", "source": "National Institute on Aging (NIH)"},
      {"url": "https://www.alzheimersresearchuk.org/news/feed/", "source": "Alzheimer's Research UK"},
      {"url": "https://medicalxpress.com/rss-feed/search/?search=alzheimer", "source": "Medical Xpress"},
]
...
FALLBACK_ARTICLES = [
      ...
      },
      {
                ...
                "description": "Scientists have identified blood-based biomarkers that could enable earlier "
                               "and more accurate detection of Alzheimer's disease, years before symptoms appear.",
      ...
      },
      {
                ...
                "description": "Researchers have developed a deep learning model that analyzes MRI brain scans "
                               "to predict Alzheimer's disease with high accuracy.",
                "url": "https://www.nih.gov/",
                "source": "NIH",
      },
      {
                "title": "Mediterranean Diet Linked to Lower Risk of Alzheimer's Disease",
                "description": "A 10-year study finds that adherence to a Mediterranean-style diet "
...
def latest_news():
    ...
    if articles:
          ...
          st.info("Could not reach news feeds right now - showing curated articles.")
